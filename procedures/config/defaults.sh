...
export JBOSS_DOWNLOAD_PATH=http://maven.brisskit.le.ac.uk/nexus/content/repositories/thirdparty/jboss/jboss-server/jboss/4.2.3.GA/jboss-4.2.3.GA.zip
export CATISSUE_INSTALLABLE_ZIP_DOWNLOAD_PATH=http://maven.brisskit.le.ac.uk/nexus/content/repositories/thirdparty/catissue/caTissue_Plus/v3.0.2_Installable/caTissue_Plus-v3.0.2_Installable.zip
export CATISSUE_INTEGRATION_WS_DOWNLOAD_PATH=http://maven.brisskit.le.ac.uk/nexus/content/repositories/releases/org/brisskit/app/catissue/caTissue-v1.2plus-WS/1.0-RC1/caTissue-v1.2plus-WS-1.0-RC1.war
export CATISSUE_ADMIN_PROCEDURES_DOWNLOAD_PATH=http://maven.brisskit.le.ac.uk/nexus/content/repositories/releases/org/brisskit/app/catissue/catissue-admin-procedures/1.0-RC1/catissue-admin-procedures-1.0-RC1.zip
export JERSEY_BUNDLE_DOWNLOAD_PATH=http://maven.brisskit.le.ac.uk/nexus/content/repositories/central/com/sun/jersey/jersey-bundle/1.3/jersey-bundle-1.3.jar
